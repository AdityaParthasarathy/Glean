...
const Velaris = ({
  ...
  useEffect(() => {
    ...
    // Set the canvas's actual pixel size before the first paint — the
    // ResizeObserver below keeps it in sync on later layout changes, but its
    // own first callback is asynchronous and can lag a frame or more behind
    // mount, otherwise briefly rendering into the browser's 300x150 default.
    resize();
    ...
    // Respect prefers-reduced-motion: paint one still frame instead of
  ...
  }, [bg, colors, speed, grain, reducedMotion]);
